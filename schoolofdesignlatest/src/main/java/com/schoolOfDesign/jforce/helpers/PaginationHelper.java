...
public class PaginationHelper<E> {
	...
	public static class Page<E> {
        ...
        public Page<E> fetchPage(
    		...
    		int beginIndex = (pageSize == 0 ? 0 : (pageNo / noOfPagesPerView) * noOfPagesPerView) + 1;
    		int endIndex = pageSize == 0 ? pageCount : ((pageNo / noOfPagesPerView) + 1 ) * noOfPagesPerView;
            ...
            if(pageSize > 0) {
            	queryBuilder.append(LIMIT_QUERY).append(pageSize).append(OFFSET_QUERY).append(startRow);
            }
