			...
			<section class="wrapper">
				<div class="row clearfix page-body">
					<div class="col-sm-12 column">
						...
						${sem}<br /> TEE Type : ${teeType} <br /> TEE Percentage : ${tee_percent}

						<form id="grade"
							action="${pageContext.request.contextPath}/gradeSubmitTEE"
							method="post">
									...
									<c:forEach items="${mrkList}" var="entry" varStatus="loop">
										...
										<tr>
											...
											<td><div class="input-group">
													<input type="number" data-tier-id="1"
								...
								.click(
										function() {
											...
											$
													.ajax({
														type : "POST",
														url : "${pageContext.request.contextPath}/saveasdraftTEE",
														data : datastring,
