				...
				<div class="row">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							...
							<li><i class="icon_piechart"></i>TEE</li>
					...
					<div class="row clearfix page-body">
						<div class="col-sm-12 column">
							<table>
								...
								<tr>
									<td>TEE Type</td>
									<td>${teeBean.teeType}</td>
								</tr>
								<tr>
									<td>TEE Percentage</td>
									<td>${teeBean.tee_percent}</td>
								</tr>
								<tr>
									<td>Owner faculty</td>
									<td>${teeBean.owner_faculty}</td>
								</tr>
								<tr>
									<td>Assigned faculty</td>
									<td>${teeBean.assigned_faculty}</td>
								</tr>
								<tr>
									<td>Course</td>
									<td>${courseName}</td>
					...
					<div class="row clearfix page-body">
						<div class="col-sm-12 column">
							...
							<div class="form-group">
								 <a href="downloadGradedTeePdf?teeId=${teeBean.id}"><i
									class="btn btn-large btn-primary">Download PDF</i></a> 
