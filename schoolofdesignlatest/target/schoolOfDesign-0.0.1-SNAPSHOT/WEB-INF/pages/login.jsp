...
<link
	href="${pageContext.request.contextPath}/resources/css/bootstrap-progressbar-3.3.4.min.css"
	rel="stylesheet">

<!-- Custom Toggle Style -->
<link href="${pageContext.request.contextPath}/resources/css/toggle.css"
	rel="stylesheet">
		...
		<div class="login_box" style="width: 500px;">
			<div class="row">
				...
				<div class="col-md-4 login_Height">
					<a href="login"><img
						src="${pageContext.request.contextPath}/resources/images/logoSOD.png"
						style="margin-left: 50px; margin-top: 50px;" alt=""></a>
					<form name="f" class="login-form"
						action="${pageContext.request.contextPath}/autheticate"
						method="post">

						<span class="tweak" style="align: center; color: red;    font-size: large;">${error}</span> <input
							type="text" name="username" placeholder="User Name" required>
						<input type="password" name="password" placeholder="Password"
							required>
						<p>

							<a href="${pageContext.request.contextPath}/changePasswordForm">Forgot
								Password!?</a>
						</p>
...
.center {
    ...
    width: fit-content;
		...
		<!-- <div class="footer">
			<footer>
				...
				<div class="col-md-3">
					<a href="mailto:portal@nmims.edu">portal@nmims.edu</a><br>1800-1025-136
					( Toll Free)
				</div>
	...
	<!-- FastClick -->
	<script
		src="${pageContext.request.contextPath}/resources/js/fastclick.js"
		type="text/javascript"></script>

	<!-- Balance Height.js -->
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/resources/js/jquery.balance.js"></script>
