				...
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header">
							<i class="icon_piechart"></i> Upload student faculty course relationship
						</h3>
				...
				<div class="row clearfix page-body">
					<div class="col-sm-12 column">
						<fieldset>
							...
							<form action="${pageContext.request.contextPath}/uploadStudentCourseFacultyMaster" method="post"
